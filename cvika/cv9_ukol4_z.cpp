...
void onDisplay(void)
{
	...
	// nepruhledne steny
	glBegin(GL_QUADS);
	glColor3f(0.8f, 0.6f, 0.0f); glVertex3i(-5, -5, -5);
	glColor3f(0.8f, 0.4f, 0.0f); glVertex3i(-5, 5, -5);
	glColor3f(0.8f, 0.2f, 0.0f); glVertex3i(5, 5, -5);
	glColor3f(0.8f, 0.0f, 0.0f); glVertex3i(5, -5, -5);

	glColor3f(0.8f, 0.6f, 0.0f); glVertex3i(-3, -3, -5);
	glColor3f(0.8f, 0.4f, 0.0f); glVertex3i(-3, 3, -5);
	glColor3f(0.8f, 0.2f, 0.0f); glVertex3i(-3, 3, 10);
	glColor3f(0.8f, 0.0f, 0.0f); glVertex3i(-3, -3, 10);
	glEnd();
	...
	// pruhledna stena
	glBegin(GL_QUADS);
	glColor4f(0.0f, 0.8f, 0.8f, 0.8f); glVertex3i(-5, -5, 5);
	glColor4f(0.0f, 0.6f, 0.8f, 0.7f); glVertex3i(-5, 5, 5);
	glColor4f(0.0f, 0.4f, 0.8f, 0.6f); glVertex3i(5, 5, 5);
	glColor4f(0.0f, 0.2f, 0.8f, 0.5f); glVertex3i(5, -5, 5);

	glColor4f(0.0f, 0.8f, 0.8f, 1.0f); glVertex3i(-5, -5, 0);
	glColor4f(0.0f, 0.6f, 0.8f, 1.0f); glVertex3i(-5, 5, 0);
	glColor4f(0.0f, 0.4f, 0.8f, 0.3f); glVertex3i(5, 5, 0);
	glColor4f(0.0f, 0.2f, 0.8f, 0.3f); glVertex3i(5, -5, 0);
	glEnd();
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Cviceni 9 - Ukol 4 (Blending)");
