...
void onInit(void) {
  ...
  // nastaveni hodnot ambient, diffuse, specular a position na pøednastavené h
  // dnoty pro svetlo c. 0 (GL_LIGHT0)
  ...
  glTexImage2D(GL_TEXTURE_2D, 0,
               GL_RGBA, // zde dojde k presunu textury do pameti graficke karty
               TEXTURE_WIDTH, TEXTURE_HEIGHT, 0, GL_RGBA, GL_UNSIGNED_BYTE,
               texture);
