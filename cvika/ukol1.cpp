...
void onInit(void)
{
	...
	// nastaveni hodnot ambient, diffuse, specular a position na pøednastavené hodnoty pro svetlo c. 0 (GL_LIGHT0)
...
void onDisplay(void)
{
	...
	// Bodovany ukool 1 - vytvorte kouli, nastavte barvu na cervenou a aplikujte translaci
